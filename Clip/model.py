    ...
    def evaluate(self, dataloader):
        ...
        for batch_idx, batch in enumerate(dataloader):
            try:
                ...
                all_attr_preds.append(attr_sim)
                all_aff_preds.append(aff_sim)
        ...
        try:
            ...
            self.logger.info(f"all_attr_labels: {all_attr_labels.shape}, all_attr_preds: {all_attr_preds.shape}")
            self.logger.info(f"all_aff_labels: {all_aff_labels.shape}, all_aff_preds: {all_aff_preds.shape}")
